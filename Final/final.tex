...
\begin{enumerate}[labelsep=2.5em, label=\textbf{\arabic{enumi}}]
  ...
  \begin{proof}
    ...
    \begin{proof}
      ...
      halts on $x$. In otherwords, \machine{H} decides \namedlangset{Halt}.
    \end{proof}
  ...
  \begin{proof}
    ...
    By \namethm{Sipser-G\'{a}cs}, we know that
    ...
    polynomial-time (and thus would use only polynomial-space during reduction).
    This implies, $\PSPACE \subseteq \FSigma_2$!
  \end{proof}
